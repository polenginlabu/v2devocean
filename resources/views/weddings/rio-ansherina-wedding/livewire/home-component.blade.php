                    ...
                    <div class="slide-inner slide-bg-image" data-background="/wedding/rio-ansherina/1920-1.png">
                        ...
                        <div class="container-fluid">
                            <div class="slide-content">
                                ...
                                <div class="s-img-1"><img src="/wedding/images/slider/shape3.png" alt=""></div>
                                <div class="s-img-2"><img src="/wedding/images/slider/shape4.png" alt=""></div>
                            </div>
                        </div>
                    </div> <!-- end slide-inner -->
                ...
                <div class="col col-xs-12">
                    <div class="couple-area clearfix">
                        ...
                        <div class="middle-couple-pic">
                            ...
                            <div class="frame-img"><img src="/wedding/images/couple/shape.png" alt=""></div>
                        </div>
    ...
    {{-- <section class="wpo-video-section-s2">
        ...
        <div class="wpo-video-item">
            <div class="wpo-video-img">
                <img src="/wedding/images/cta2.jpg" alt="">
    ...
    {{-- <div class="wpo-cta-section-s3">
        <div class="conatiner-fluid">
            <div class="wpo-cta-item">
                ...
                <p>Nov 22,2024, Wedding Unity Center, road 525 USA</p>
                ...
                <div class="row">
                    <div class="col col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="widget about-widget">
                            <div class="logo widget-title">
                                <img src="/wedding/images/logo.png" alt="blog">
                            </div>
                    ...
                    <div class="col col-xl-3  col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="widget instagram">
                            ...
                            <ul class="d-flex">
                                <li><a href="portfolio-single.html"><img src="/wedding/images/instragram/1.jpg"
                                            alt=""></a></li>
                                <li><a href="portfolio-single.html"><img src="/wedding/images/instragram/2.jpg"
                                            alt=""></a></li>
                                <li><a href="portfolio-single.html"><img src="/wedding/images/instragram/3.jpg"
                                            alt=""></a></li>
                                <li><a href="portfolio-single.html"><img src="/wedding/images/instragram/4.jpg"
                                            alt=""></a></li>
                                <li><a href="portfolio-single.html"><img src="/wedding/images/instragram/5.jpg"
                                            alt=""></a></li>
                                <li><a href="portfolio-single.html"><img src="/wedding/images/instragram/6.jpg"
                                            alt=""></a></li>
                            </ul>
                        </div>
                    </div>
